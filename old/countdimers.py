...
with open('/Users/Ethan/Desktop/fa_files/cont2/names2','r') as infile:
    lines = infile.readlines()
    filenames =[str(e.strip()) for e in lines]
infile.close()

with open('/Users/Ethan/Desktop/fa_files/cont2/results.td','w+') as finalout:
    ...
    for f in filenames:
        ...
        GG = 0
        GC = 0
        with gzip.open('/Users/Ethan/Desktop/fa_files/cont2/'+str(f) + '.fa.gz','rb') as infile:
            lines = infile.readlines()
            for line in lines:
                if line.startswith('>'):
                    pass
